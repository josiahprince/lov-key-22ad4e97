-- Update the generate_daily_matches function to allow re-matching with previously matched users
...
BEGIN
  ...
  LOOP
    ...
    -- Find potential matches for this user (REMOVED: exclusion of previously matched users)
