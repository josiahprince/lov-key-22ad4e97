-- Fix duplicate match prevention logic
  ...
  LOOP
    ...
    FOR potential_match IN
      ...
      WHERE uo2.user_id != user_record.user_id
        ...
        -- Don't match users who already have ANY match between them (regardless of status)
        AND NOT EXISTS (
    ...
    LOOP
      ...
      IF match_score_calc >= 20 THEN
        ...
        -- Create the match (use match_score instead of compatibility_score)
        BEGIN
